...
public class MemberDAOImpl implements MemberDAO {
	...
	@Override
	public MemberVO selectMemberById(SqlSession session, String memberId) throws SQLException {
		MemberVO member = session.selectOne("Member-Mapper.selectMemberByMemberId",memberId);
		return member;
	}
	...
	@Override
	public void deleteMember(SqlSession session, String memberId) throws SQLException {
		session.update("Member-Mapper.deleteMember",memberId);
	}
