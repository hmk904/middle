...
public interface MemberDAO {
	...
	// 회원정보 조회
	MemberVO selectMemberById(SqlSession session, String memberId) throws SQLException;
	...
	// 회원정보 삭제
	void deleteMember(SqlSession session, String memberId) throws SQLException;
