...
<div class="contents">
	...
	<div class="book_list">
		<c:forEach items="${libraryBookList }" var="libraryBook">
			<ul>

				<li><a style="cursor: pointer;"
					onclick="javascript:OpenWindow('detail.do?libraryBookNum=${libraryBook.libraryBookNum }','상세보기',800,700);">

						<div class="book_info" style="width: 100%">
							<h4>${libraryBook.libraryBookTitle }</h4>
							<ul>
								<li><strong>저자</strong>${libraryBook.libraryBookWriter }</li>
								<li><strong>출판사</strong>${libraryBook.libraryBookCompany }</li>
								<li><strong>ISBN</strong>${libraryBook.libraryBookNum }</li>
							</ul>
						</div>
				</a></li>
