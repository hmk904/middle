...
<c:set var="cri" value="${dataMap.pageMaker.cri }" />
  <div class="conTitle">
    ...
    <ul class="snavi02">
      ...
      <li>
        ...
        <a href="/hanbatlibrary/board/boardNormalList.do?boardId=normal_1020&amp;menuSeq=6242">공지사항</a>
  ...
  <div class="contents">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="left notice">
            <a href="<%=request.getContextPath() %>/notice/detail.do?noticeNum=${notice.noticeNum }">
              ${notice.noticeTitle }
            </a>
          </td>
          <td class="notice">
          ...
          <td class="notice">${notice.noticeSearch }</td>
    ...
    <div class="bd_btn_area right">
    					<a href="<%=request.getContextPath() %>/notice/registForm.do">글쓰기</a>
				    </div>
