			...
			<div class="cal_view02">
				<div class="bk_info" style="width: 100%">
					...
					<ul class="h6_ul">
						...
						<li><strong>자료유형</strong><span>${newBook.newDataType }</span></li>

						<li><strong>개인저자</strong><span>${newBook.newWriter }</span></li>

						<li><strong>서명/저자사항</strong><span>영화 프로듀서 매뉴얼 /박대희
								;어지연 ;유은정 [공] 저 ;영화진흥위원회 연구주관</span></li>

						<li><strong>발행사항</strong><span>${newBook.newIssue }</span></li>

						<li><strong>형태사항</strong><span>${newBook.newFormal }</span></li>

						<li><strong>총서사항</strong><span>${newBook.newGeneral }
								</span></li>

						<li><strong>ISBN</strong><span>${newBook.newBookNum }</span></li>

						<li><strong>서지주기</strong><span>${newBook.newNote }</span></li>
				...
				<div
					...
					<div class="bd_btn_area center mt30">
						<a onclick="OpenWindow('modifyForm.do?newBookNum=${newBook.newBookNum}','상세보기',800,200);" class="btn_gray">수정하기</a>
					</div>
					<div class="bd_btn_area center mt30">
						<a onclick="location.href='remove.do?newBookNum=${newBook.newBookNum}';" id="deleteBtn" class="btn_red">삭 제</a>
					</div>
					<div class="bd_btn_area center mt30">
